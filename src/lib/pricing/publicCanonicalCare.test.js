...
function makeCatalogOptions() {
  return [
    ...
    option({ offering: OFFERINGS.DROP_IN, code: "DROP_IN_CAT_15", label: "Cat drop-in · 15 minutes", primarySpecies: "Cat", durationMinutes: 15, sortOrder: 40, baseRateCents: 2000, charges: [["Cat", 1, 300]] }),
    option({ offering: OFFERINGS.DROP_IN, code: "DROP_IN_CAT_30", label: "Cat drop-in · 30 minutes", primarySpecies: "Cat", durationMinutes: 30, sortOrder: 50, baseRateCents: 2500, charges: [["Cat", 1, 300]] }),
    option({ offering: OFFERINGS.DROP_IN, code: "DROP_IN_CAT_60", label: "Cat drop-in · 60 minutes", primarySpecies: "Cat", durationMinutes: 60, sortOrder: 60, baseRateCents: 3000, charges: [["Cat", 1, 300]] }),
    option({ offering: OFFERINGS.DOG_WALK, code: "DOG_WALK_15", label: "15 minutes", primarySpecies: "Dog", durationMinutes: 15, sortOrder: 10, baseRateCents: 2200 }),
