...
const CLIENT_RATES = [
  ...
  ["DROP_IN_DOG_30", 2500],
  ["DROP_IN_DOG_60", 3000],
  ["DROP_IN_CAT_15", 2000, 2],
  ["DROP_IN_CAT_30", 2500, 2],
  ["DROP_IN_CAT_60", 3000, 2],
  ["DOG_WALK_15", 2200, 2],
  ["DOG_WALK_30", 2200],
  ["DOG_WALK_60", 3000],
  ["OVERNIGHT_DOG_HOME", 6000],
  ["OVERNIGHT_CAT_HOME", 4200],
].map(([optionCode, baseRateCents, version = 1]) => ({
  optionCode,
  baseRateCents,
  version,
}));
...
const PARITY_CASES = [
  ...
  ["1 Cat Drop-In 15", "DROP_IN_CAT_15", { Cat: 1 }, 2000],
  ["2 Cat Drop-In 15", "DROP_IN_CAT_15", { Cat: 2 }, 2300],
  ["3 Cat Drop-In 15", "DROP_IN_CAT_15", { Cat: 3 }, 2600],
  ["1 Cat Drop-In 30", "DROP_IN_CAT_30", { Cat: 1 }, 2500],
  ["2 Cat Drop-In 30", "DROP_IN_CAT_30", { Cat: 2 }, 2800],
  ["3 Cat Drop-In 30", "DROP_IN_CAT_30", { Cat: 3 }, 3100],
  ["1 Cat Drop-In 60", "DROP_IN_CAT_60", { Cat: 1 }, 3000],
  ["2 Cat Drop-In 60", "DROP_IN_CAT_60", { Cat: 2 }, 3300],
  ["3 Cat Drop-In 60", "DROP_IN_CAT_60", { Cat: 3 }, 3600],
  ["Dog Walk 15", "DOG_WALK_15", { Dog: 1 }, 2200],
